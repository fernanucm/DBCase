...
public class GUI_AnadirAtributoRelacion extends javax.swing.JDialog implements KeyListener, MouseListener {
	...
	private JCheckBox getOpcionCompuesto() {
		if(opcionCompuesto == null) {
			...
			opcionCompuesto.setBounds(142, 118, 220, 18);
	...
	private JCheckBox getOpcionNotnull() {
		if(opcionNotnull == null) {
			...
			opcionNotnull.setBounds(142, 138, 220, 18);
	...
	private JCheckBox getOpcionUnique() {
		if(opcionUnique == null) {
			...
			opcionUnique.setBounds(142, 158, 220, 18);
	...
	private JCheckBox getOpcionMultivalorado() {
		if(opcionMultivalorado == null) {
			...
			opcionMultivalorado.setBounds(142, 178, 221, 18);
	...
	private JTextPane getJTextPane2() {
		if(jTextPane2 == null) {
			...
			jTextPane2.setBounds(129, 228, 231, 20);
	...
	private JComboBox getComboDominios() {
		if(comboDominios == null) {
			...
			comboDominios.setBounds(129, 254, 231, 21);
	...
	private JTextField getCajaTamano() {
		if(cajaTamano == null) {
			...
			cajaTamano.setBounds(208, 281, 152, 21);
		}
	...
	private JLabel getLabelTamano() {
		if(labelTamano == null) {
			...
			labelTamano.setBounds(129, 281, 67, 14);
		}
		return labelTamano;
	}
	...
	private JButton getBotonAnadir() {
		if(botonAnadir == null) {
			...
			botonAnadir.setBounds(196, 343, 80, 25);
	...
	private JButton getBotonCancelar() {
		if(botonCancelar == null) {
			...
			botonCancelar.setBounds(281, 343, 80, 25);
