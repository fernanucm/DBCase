...
*/
public class PanelOpcionesPequeno extends javax.swing.JDialog implements KeyListener {
	{
		//Set Look & Feel
		try {
	...
	private void initComponents() {
		...
		setResizable(false);
		{
			...
			pregunta.setBounds(80, 21, 180, 48);
		...
		}
		{
			...
			labelIcono.setBounds(12, 12, 61, 63);
		}
		{
			botonSi = new JButton();
	...
	public int setActiva(String mensaje, String titulo, boolean cancelar,Icon icon){
		...
		if(cancelar){
			...
			botonSi.setBounds(14, 81, 80, 25);
			botonNo.setBounds(102, 81, 80, 25);
		}else{
			botonCancelar.setVisible(false);
			botonCancelar.setFocusable(false);
			botonSi.setBounds(102, 81, 80, 25);
			botonNo.setBounds(190, 81, 80, 25);
		}
