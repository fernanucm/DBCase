...
public class allIcon extends icon{
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
    	...
    	g2d.draw(rect);
    	g2d.draw(new Line2D.Double(getIconWidth()*.45,getIconHeight()*.05,getIconWidth()*.45,getIconHeight()*.85));
    	g2d.draw(new Line2D.Double(getIconWidth()*.7,getIconHeight()*.05,getIconWidth()*.7,getIconHeight()*.85));
    	g2d.draw(new Line2D.Double(getIconWidth()*.7,getIconHeight()*.45,getIconWidth()*.9,getIconHeight()*.45));
    }	
}
